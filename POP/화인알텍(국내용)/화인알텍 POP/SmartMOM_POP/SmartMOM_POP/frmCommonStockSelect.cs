    ...
    public partial class frmCommonStockSelect : Form
    {
        ...
        public frmCommonStockSelect(string selectType)
        {
            ...
            else if (selectType == "Pallet구성")
            {
                ...
                clsStatic._STOCK_TYPE_NAME = selectType;
            }
            ...
            string conBuf = "";
            DataSet ds = clsUtil.form_load(clsStatic._STOCK_TYPE_NAME, ref conBuf);
            ...
            if(strs.Length == 4)
            {
                ...
                clsStatic._FROMLINE_DESC = strs[1];
                clsStatic._TOLINE        = strs[2];
                clsStatic._TOLINE_DESC   = strs[3];
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                frmMessage frm1 = new frmMessage("From라인과 To라인을 입력하여 주세요!", "AUTOCLOSE");
                frm1.ShowDialog();
                return;
            }
            ...
            {
                frmMessage frm1 = new frmMessage("현재창고를 입력하여 주세요!", "AUTOCLOSE");
                frm1.ShowDialog();
                return;
            }
            ...
            clsUtil.form_save(clsStatic._LINEREMEMBER, null, clsStatic._STOCK_TYPE_NAME);
