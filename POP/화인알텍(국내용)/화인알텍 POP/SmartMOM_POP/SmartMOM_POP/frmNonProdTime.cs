...
namespace SmartMOM_POP
{
    public partial class frmNonProdTime : Form
    {
        ...
        {
            frmMessage frm = new frmMessage(lblTitle.Text + ")을/를 완료 하겠습니까?", "OK_CANCEL");
            ...
            if (result == DialogResult.OK)
            {
                ...
                ts_value = ts.TotalSeconds.ToString();
        ...
        {
            frmMessage frm = new frmMessage("비가동이 진행중입니다. POP 프로그램을 닫으시겠습니까?", "OK_CANCEL");
            DialogResult result = frm.ShowDialog();
