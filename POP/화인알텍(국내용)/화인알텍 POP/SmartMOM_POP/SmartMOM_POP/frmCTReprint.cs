...
namespace SmartMOM_POP
{
    public partial class frmCTReprint : Form
    {
        ...
        DataTable _nodataDt = new DataTable();
        ...
        private void getNodataGTList()
        {
            ...
            _nodataDt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.get_popgt_list.dummy", paramsList, clsStatic._serviceSelectURL, ref retvalue);

            if(_nodataDt.Rows.Count > 0)
            {
                btnNodataGT.Visible = true;
            }
        }
        ...
        {
            frmGTReprint frm = new frmGTReprint(_ct, _gtType, _ctType, _gt_DesignDt, _ct_DesignDt, _BasicDs);
            frm.ShowDialog();
        }

        private void btnNodataGT_Click(object sender, EventArgs e)
        {
            frmGTReprint frm = new frmGTReprint("NODATA", _gtType, _ctType, _gt_DesignDt, _ct_DesignDt, _BasicDs);
            frm.ShowDialog();
        }
    }
}
