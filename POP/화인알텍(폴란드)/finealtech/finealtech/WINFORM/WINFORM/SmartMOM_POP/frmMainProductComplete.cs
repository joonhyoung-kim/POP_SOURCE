...
namespace SmartMOM_POP
{
    public partial class frmMainProductComplete : Form
    {
        ...
        private void get_longshortsn()
        {
            ...
            DataTable dt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.get_longshortsn.dummy", paramsList1, clsStatic._serviceSelectURL, ref retvalue);
        ...
        private int gtCount()
        {
            ...
            {
                int qty = int.Parse(grdGT.Rows[i].Cells["QTY"].Value.ToString());
