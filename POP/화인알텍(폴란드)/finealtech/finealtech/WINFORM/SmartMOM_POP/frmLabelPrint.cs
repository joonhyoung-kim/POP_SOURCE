...
namespace SmartMOM_POP
{
    public partial class frmLabelPrint : Form
    {
        ...
        private void grdMain_InitLabelList()
        {
            ...
            string[] headerText = new string[] { "PLAN DATE",     "W/O STATE",   "W/O",           "Line",       "Line Name",     "P/N",     "P/N Desc.",  "SPEC",          "PLAN QTY",   "PROD QTY",   "BAD QTY",   "CANCEL QTY",   "REMAIN QTY", "S/N COUNT",    "GANBAN COUNT",     "W/O START",  "W/O END",  "SNLABELID",  "GANBANLABELID",  "WOCODE",  "IDRULE",  "ITEMTYPE", "CTQTY"      }; //23
            string[] columnName = new string[] { "PLANSTARTTIME", "WOSTATEDESC", "WORKORDERID",   "RESOURCECD", "RESOURCENAME",  "ITEMID",  "ITEMNAME",   "SPECIFICATION", "CONFIRMQTY", "GOODQTY",    "BADQTY",    "CANCELQTY",    "REMAINQTY",  "SNALLCOUNT",   "GANBANALLCOUNT",   "STARTTIME",  "ENDTIME",  "SNLABELID",  "GANBANLABELID",  "WOSTATE", "IDRULE",  "ITEMTYPE", "POPCTQTY"   };
                                                                  
            string[] columnType = new string[] { "T",             "T",           "T",             "T",          "T",             "T",       "T",          "T",             "T",          "T",          "T",          "T",           "T",          "T",            "T",                "T",          "T",        "T",          "T",              "T",       "T",       "T",        "T"          };
            int[] columnWidth    = new int[]   { 100,             90,            127,             80,           123,             160,       230,          200,             110,          110,          110,          110,           110,          110,            100,                173,          173,        100,          100,              70,        70,        70,         70           };
            bool[] columnVisible = new bool[]  { true,            true,          true,            true,         true,            true,      true,         true,            true,         true,         true,         true,          true,         true,           true,               true,         true,       true,         true,             true,      true,      true,       true         };
            bool[] columnDisable = new bool[]  { true,            true,          true,            true,         true,            true,      true,         true,            true,         true,         true,         true,          true,         true,           true,               true,         true,       true,         true,             true,      true,      true,       true         };
            string[] cellAlign = new string[]  { "C",             "C",           "C",             "C",          "L",             "L",       "L",          "L",             "R",          "R",          "R",          "R",           "R",          "R",            "R",                "C",          "C",        "C",          "C",              "C",       "C",       "C",        "C"          };
        ...
        private void grdMain_Color_change()
        {
            ...
            for (int i = 0; i < grdMain.Rows.Count; i++)
            {
                ...
                if(int.Parse(ganbanCount) > 0 || int.Parse(snCount) > 0)
                {
                    for (int j = 1; j < grdMain.ColumnCount; j++)
                    {
        ...
        private void grdMain_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (rowIndex >= 0)
            {
                ...
                frmLabelPrintDetail frm = new frmLabelPrintDetail(resourceId, resorceName, pn, pndesc, spec, plandate, wo, planqty, ganbanId, labelId, wocode, idrule, itemtype, ctqty);
                frm.ShowDialog();
            }
