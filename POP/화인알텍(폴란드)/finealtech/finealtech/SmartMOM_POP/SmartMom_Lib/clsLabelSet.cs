...
namespace SmartMom_Lib
{
    public static class clsLabelSet
    {
        ...
        public static DataTable getBADNONCODEList()
        {
            List<Dictionary<string, object>> paramsList = new List<Dictionary<string, object>>();
            Dictionary<string, object> paramsMap = new Dictionary<string, object>();
            paramsMap.Add("p_err_code", "");
            ...
            DataTable dt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.get_nonworkcode.dummy", paramsList, clsStatic._serviceSelectURL, ref retvalue);
        ...
        public static void label_print(string _macAddress, string printid, string pallet, string gt, string ct, string ganbanid, int maxcnt, int nowcnt, string reprintFlag, ref DataSet BasicDs)
        {
            string labeltype = "";
            List<Dictionary<string, object>> paramsList = new List<Dictionary<string, object>>();
            Dictionary<string, object> paramsMap = new Dictionary<string, object>();
            ...
            else if (gt != "")
            {
                ...
                paramsMap.Add("DIVISION_CD", clsStatic._DIVISION_CD);
                paramsMap.Add("COMPANY_CD", clsStatic._COMPANY_CD);
                paramsMap.Add("WORK_ORDER_RESULT_ID", gt);

                paramsList.Add(paramsMap);

                dt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.get_productlabelinfo.dummy", paramsList, clsStatic._serviceSelectURL, ref retvalue);
            }
            else
            {
                paramsMap.Add("p_err_code", "");
                ...
                dt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.get_labelsninfo2.dummy", paramsList, clsStatic._serviceSelectURL, ref retvalue);
            }
            ...
            {
                //해당 모델의 간판라벨정보가 설정되어 있지 않습니다.
                frmMessage frm = new frmMessage("The Ganban label information of the model is not set.", "AUTOCLOSE");
                frm.ShowDialog();
                return;
            }
            ...
            if (gt != "" && gtType == "")
            {
                //해당 모델의 제품라벨정보가 설정되어 있지 않습니다.
                frmMessage frm = new frmMessage("The product label information of the model is not set.", "AUTOCLOSE");
                frm.ShowDialog();
                return;
            }
            ...
            try
            {
                string coluse = dt.Rows[0]["GOODQTY"].ToString();

                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    qty += int.Parse(dt.Rows[i]["GOODQTY"].ToString().Replace(",", ""));
                }
            ...
            if (ganbanid != "")
            {
                ...
                ganban_DesignDt = clsLabelSet.LabelDesignDataSet(ganbantType);

                paramPrintMap.Add("SEQ", (nowcnt + 1).ToString() + " / " + maxcnt.ToString());
            ...
            else if (ct != "")
            {
                ...
                ct_DesignDt = clsLabelSet.LabelDesignDataSet(ctType);
            ...
            else if (gt != "")
            {
                ...
                gt_DesignDt = clsLabelSet.LabelDesignDataSet(gtType);
            ...
            else if (pallet != "")
            {
                ...
                ct_DesignDt = clsLabelSet.LabelDesignDataSet(palletType);

                clsLabelSet.map_label_print(paramPrintMap, _macAddress, "PALLETPRINT", ref ct_DesignDt, ref BasicDs);
            }
        }

        public static void label_print2(string _macAddress, string printid, string pallet, string gt, string ct, string ganbanid, int maxcnt, int nowcnt, string led, string press,  string reprintFlag, ref DataSet BasicDs)
        {
            string labeltype = "";
            List<Dictionary<string, object>> paramsList = new List<Dictionary<string, object>>();
            Dictionary<string, object> paramsMap = new Dictionary<string, object>();
            ...
            else if (ct != "")
            {
                ...
                paramPrintMap.Add("LED", led);
                paramPrintMap.Add("PRESS", press);
        ...
        public static void label_print3(string _macAddress, string printid, string pallet, string gt, string ct, string ganbanid, int maxcnt, int nowcnt, string reprintFlag, ref DataSet BasicDs)
        {
            string labeltype = "";
            List<Dictionary<string, object>> paramsList = new List<Dictionary<string, object>>();
            Dictionary<string, object> paramsMap = new Dictionary<string, object>();
