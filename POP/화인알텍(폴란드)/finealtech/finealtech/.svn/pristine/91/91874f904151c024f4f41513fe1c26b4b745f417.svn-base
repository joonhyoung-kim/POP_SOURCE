...
var MOMFA007 = {
	init: function() {
		...
		$(document).on("click", "#findBtn", function(){
			...
			mCommon.render("grid", "W201808111728372531000vd88UvIXfh6",
		...
		$(document).on("click", "#detailBtn", function(){
			...
			if(checkedItem.length <= 0){
				...
				param = {itemId : checkedItem[0].item.itemId}
				$("#pop").micaModal("show");
	...
	callBack: function(param, data) {
		if(param == 'SUCCESS') {
			mCommon.render("grid", "W201808111728372531000vd88UvIXfh6", mCommon.formGetParam("#form"), function(){
