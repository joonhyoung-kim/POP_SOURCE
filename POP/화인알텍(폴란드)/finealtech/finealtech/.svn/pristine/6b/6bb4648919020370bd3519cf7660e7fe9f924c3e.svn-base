...
namespace SmartMOM_POP
{
    public partial class frmCommonSelect : Form
    {
        ...
        public frmCommonSelect(string selectType)
        {
            ...
            if (clsStatic._resouceType == "LINE")
            {
                if (clsStatic._USEMANAGEMENT == "STOCK") 
                {
                    ...
                    btnBody01.Text = "Mat. Receiving";
                    btnBody02.Text = "Mat. Release";
                    btnBody03.Text = "Label Split";
                    btnBody04.Text = "Move/Return";
                    btnBody05.Text = "Mat. Input";
                    btnBody06.Text = "Shipment";
                    btnBody07.Text = "Label Issue";
                    btnBody07.Visible = true;
                    btnPrev.Text = "Exhaust Cancel";
                    btnPrev.Visible = true;
                    btnPrev.BackColor = btnBody01.BackColor;
                    btnPrev.ForeColor = btnBody01.ForeColor;
                    btnPrev.Font = btnBody01.Font;
            ...
            else if (clsStatic._resouceType == "EQUIPMENT")
            {
                equipment_process();
            }
            //else if (clsStatic._resouceType == "FROM" || clsStatic._resouceType == "TO")
        ...
        private void equipment_process()
        {
            _buttonDt = clsStatic.getEquipment();
        ...
        private void button_init()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                else
                {
                    ...
                    if (clsStatic._resouceType == "LINE")
                    {
                        _prodButton[i].Tag = _buttonDt.Rows[buttoncnt]["EQUIPMENTNUM"].ToString();
                    }
                }
                buttoncnt++;
            }
        ...
        private void btnPrintConfig_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                lblTitle.Text = "SmartPOP Login(" + dt.Rows[0]["USEMANAGEMENT"].ToString() + ")";
        ...
        {
            if (btnNext.BackColor == btnBody01.BackColor)
            {
        ...
        {
            if (btnPrev.BackColor == btnBody01.BackColor)
            {
                btnBody_Click(sender, e);
                return;
            }
        ...
        private void btnBody_Click(object sender, EventArgs e)
        {
            ...
            else if (clsStatic._resouceType == "LINE")
            {
                if (clsStatic._USEMANAGEMENT == "PRODUCT_COMPLETE" || clsStatic._USEMANAGEMENT == "PRODUCT_INPUT")
                {
                    ...
                    clsStatic._EQUIPMENT_NUM = ((Button)sender).Tag.ToString();
                }
                else
                {
            ...
            else if (clsStatic._resouceType == "EQUIPMENT")
            {
                ...
                clsStatic._EQUIPMENT_CD = strs[strs.Length - 1].Substring(0, strs[strs.Length - 1].Length - 1);
                clsStatic._EQUIPMENT_NAME = strs[0];

                buf = clsStatic._EQUIPMENT_CD;
            }
