...
var colModelData = [];
var hdieColumn = ["require", "popupType", "edit", "excelTempleteHide", "sort", "sortType", "listCode", "message"];
var index = {
	init: function() {
//		var colModel = [{"headerText":"divisionCd","dataField":"divisionCd","width":80,"hide":true, "popupType": "input",},{"headerText":"콤파니코드1","dataField":"companyCd","width":80},{"headerText":"shiftId","dataField":"shiftId","width":80},{"headerText":"shiftCd","dataField":"shiftCd","width":80},{"headerText":"shiftCdName","dataField":"shiftCdName","width":80},{"headerText":"startTime","dataField":"startTime","width":80},{"headerText":"endTime","dataField":"endTime","width":80},{"headerText":"applyStateTime","dataField":"applyStateTime","width":80},{"headerText":"applyEndTime","dataField":"applyEndTime","width":80},{"headerText":"resourceCd","dataField":"resourceCd","width":80},{"headerText":"resourceName","dataField":"resourceName","width":80},{"headerText":"normalInWorkHour","dataField":"normalInWorkHour","width":80},{"headerText":"normalDrWorkHour","dataField":"normalDrWorkHour","width":80},{"headerText":"extraInWorkHour","dataField":"extraInWorkHour","width":80},{"headerText":"extraDrWorkHour","dataField":"extraDrWorkHour","width":80},{"headerText":"normalInPersonCnt","dataField":"normalInPersonCnt","width":80},{"headerText":"normalDrPersonCnt","dataField":"normalDrPersonCnt","width":80},{"headerText":"extraInPersonCnt","dataField":"extraInPersonCnt","width":80},{"headerText":"extraDrPersonCnt","dataField":"extraDrPersonCnt","width":80},{"headerText":"normalInAcHour","dataField":"normalInAcHour","width":80},{"headerText":"normalDrAcHour","dataField":"normalDrAcHour","width":80},{"headerText":"extraInAcHour","dataField":"extraInAcHour","width":80},{"headerText":"extraDrAcHour","dataField":"extraDrAcHour","width":80},{"headerText":"useYn","dataField":"useYn","width":80},{"headerText":"description","dataField":"description","width":80},{"headerText":"createBy","dataField":"createBy","width":80},{"headerText":"createUserName","dataField":"createUserName","width":80},{"headerText":"updateDate","dataField":"updateDate","width":80},{"headerText":"updateBy","dataField":"updateBy","width":80},{"headerText":"updateUserName","dataField":"updateUserName","width":80},{"headerText":"result","dataField":"result","width":80}];
		var colModel = windowParam.options.colModel;
		var options = windowParam.options;
		this.event();
		this.columnGridSet(colModel);
		this.generalGridSet(options);
		this.resize();
		this.title();
	},
	resize: function() {
