...
//			}
	...
	,
	priceCallbackPost : function(param, data) {
		if(data == 'success') {
			if(param.result == 'success') {
				...
				micaCommon.messageBox({type:"danger", width:"400", height: "145", html:Language.lang['MESSAGES10821'] + " \n" + Language.getLang(param.p_err_msg)});
				console.log(param);
			}
		} else {
			if(data.p_err_msg != null && data.p_err_msg != undefined && data.p_err_msg != '') {
				micaCommon.messageBox({type:"danger", width:"400", height: "145", html: Language.getLang(param.p_err_msg)});
			} else {
				micaCommon.messageBox({type:"danger", width:"400", height: "145", html: Language.lang['MESSAGES10821']});
			}
			console.log(param);
