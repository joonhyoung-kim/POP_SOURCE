...
//				}
				...
				if(checkedItems[i].item.woState != "T" && checkedItems[i].item.woState != "R") {
...
//				}
	...
	deductionCallback : function(param, data, callbackParam, flag) {
		var that = this.MOMDA008;
...
//					}
	...
	deleteCallback : function(param, data, callbackParam, items) {
		var that = this.MOMDA008;
		var item = {
	...
	woStartCallback : function(param, data, callbackParam, flag) {
		var that = this.MOMDA008;
		if(param == 'SUCCESS') {
			if(flag == true) {
				mCommon.render("grid", "W201808010604309981000mpYThRg9RPO",  that.getSearchData(), function(){
