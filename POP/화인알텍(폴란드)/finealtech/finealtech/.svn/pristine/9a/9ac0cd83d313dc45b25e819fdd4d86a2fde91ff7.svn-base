...
namespace SmartMOM_POP
{
    public partial class frmNonProdTime : Form
    {
        ...
        private void btnStop_Click(object sender, EventArgs e)
        {
            ...
            frmMessage frm = new frmMessage("Do you want to stop NON-WORK?", "OK_CANCEL");
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            frmMessage frm = new frmMessage("NON-WORK is in progress.Do you want to close the screen?", "OK_CANCEL");
            DialogResult result = frm.ShowDialog();
