...
//			if(!matchValidP.test($("#pStartTime").val()) || $("#pStartTime").val().length != 5) {
...
//			if(!matchValidP.test($("#pEndTime").val()) || $("#pEndTime").val().length != 5) {
...
//			}
	...
	delCallback : function(param, data, callbackParam, flag) {
