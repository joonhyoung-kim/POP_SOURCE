...
namespace SmartMOM_POP
{
    public partial class frmMaterialGI : Form
    {
        ...
        private void InitGridList()
        {
            ...
            int[] columnWidth    = new int[]   { 110,          195,      200,        270,            130,           130,             130,           130,         130,          160,           80,             270,             270,              140,               250,                  250,        250,          250,                250,              250,                 250           };
            bool[] columnVisible = new bool[]  { true,         true,     true,       false,           true,          true,            true,          true,        true,         true,          true,           true,            true,             true,              true,                 true,       true,         true,               true,             true,                true          };
        ...
        private void grdMain_Color_change()
        {
            for (int i = 0; i < grdMain.Rows.Count; i++)
            {
                ...
                int remainQty = int.Parse(grdMain["잔량", i].Value.ToString().Replace(",", ""));
                int scanQty = int.Parse(grdMain["스캔수량", i].Value.ToString().Replace(",", ""));
