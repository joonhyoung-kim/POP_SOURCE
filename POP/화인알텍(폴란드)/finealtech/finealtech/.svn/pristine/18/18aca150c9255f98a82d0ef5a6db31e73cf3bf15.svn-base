...
namespace SmartMom_Lib
{
    public partial class frmPrintConfig : Form
    {
        ...
        public frmPrintConfig()
        {
            ...
            comboManage.Items.Add("GANBAN_PRINT");         // 라벨 선 발행
            ...
            if(macDt.Rows.Count > 0)
            {
                ...
                string inputtype     = macDt.Rows[0]["inputtype"].ToString();
        ...
        private void btnGT_Click(object sender, EventArgs e)
        {
            ...
            {
                //출력 PORT 값이 NONE이면 인쇄가 되지 않습니다.
                frmMessage frm1 = new frmMessage("If the output PORT value is NONE, the printer will not print.", "AUTOCLOSE");
                frm1.ShowDialog();
                return;
            }
        ...
        {
            //저장하시겠습니까?
            frmMessage frm = new frmMessage("Do you want to save?", "OK_CANCEL");
            ...
            if(result == DialogResult.OK)
            {
                ...
                string inputtype = comboInputtype.Text;
                ...
                {
                    //모든 값을 입력하여 주세요.
                    frmMessage frm1 = new frmMessage("Please enter all values.", "OK");
                    frm1.ShowDialog();
                    return;
                }
                ...
                paramsMap.Add("P_GANBANPRINT", ctprint);
                paramsMap.Add("P_PRINTID", printid);
                paramsMap.Add("P_INPUTTYPE", inputtype);
                ...
                if(macDt.Rows.Count > 0)
                {
                    ...
                    {
                        //프린터 정보가 저장되었습니다.
                        frmMessage frm1 = new frmMessage("The printer information has been saved.", "OK");
                        frm1.ShowDialog();
                    }
                    else
                    {
                        //프린터 정보가 저장되지 않았습니다!
                        frmMessage frm1 = new frmMessage("The printer information was not saved!", "OK");
                        frm1.ShowDialog();
                    }
                }
            }
