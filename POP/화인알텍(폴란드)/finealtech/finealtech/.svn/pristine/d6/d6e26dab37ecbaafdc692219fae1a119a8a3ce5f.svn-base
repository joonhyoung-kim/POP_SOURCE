...
namespace SmartMOM_POP
{
    public partial class frmLogin : Form
    {
        public frmLogin()
        {
            ...
            //clsStatic._serviceSelectURL = "http://10.10.1.7:8200/TU_Platform/pop/request";
            //clsStatic._serviceUsertURL = "http://10.10.1.7:8200/TU_Platform/pop/request/upsert";
