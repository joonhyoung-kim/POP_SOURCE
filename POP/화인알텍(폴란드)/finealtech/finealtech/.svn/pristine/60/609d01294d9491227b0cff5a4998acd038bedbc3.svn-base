var dashboard = {
	...
	//		mCommon.init("chart2", "W201809111424477751001F8Br8utn8ma");
			mCommon.init("chart3", "W201809111425250271002lEBa7Os9WZj", null, null, Language);
	//		mCommon.init("chart4", "W201809111718077291000PocvMOiixaJ");
			mCommon.renderMockChart("chart1", "W201809111314422441000QWrobyIm9vR", Language);
	//		mCommon.renderMockChart("chart2", "W201809111424477751001F8Br8utn8ma");
			mCommon.renderMockChart("chart3", "W201809111425250271002lEBa7Os9WZj", Language);
	//		mCommon.renderMockChart("chart4", "W201809111718077291000PocvMOiixaJ");
	//		mCommon.render("chart4", "W201809111718077291000PocvMOiixaJ");
		});
		this.grid();
		this.chart();
		this.event();
		this.topDashboard();
//		http://localhost:8100/micaweb/mica/projects/P201804111903105551018ozUvjWVkVGo/datasets/Dashboard_Chart_1/datas
//		mCommon.render("chart1", "null");
//		mCommon.render("chart2", "null");
//		mCommon.render("chart3", "null");
//		mCommon.render("chart4", "null");
	}, grid: function() {
...
//		
	...
	chart: function() {
		...
		var chartBottomOption = {"tooltip":{"trigger":"axis","axisPointer":{"type":"cross","crossStyle":{"color":"#999"}}},"toolbox":{"feature":{"dataView":{"show":true,"readOnly":false},"magicType":{"show":true,"type":["line","bar"]},"restore":{"show":true},"saveAsImage":{"show":true}}},
				...
				"yAxis":[{"type":"value","name":Language.lang['MESSAGES11761'],"min":0,"axisLabel":{"formatter":"{value}","show":true,"inside":false},"splitLine":{"show":true},"splitArea":{"show":false},"axisLine":{"show":true},"axisTick":{"show":true,"alignWithLabel":false},"silent":false},
...
//					"max":60,"interval":20,
		...
		$.get(tuCommon.contextPath() + "/mom/request/com.thirautech.mom.addition.dashboard.comPurchaseSalesWeekly.dummy", function (data) {
