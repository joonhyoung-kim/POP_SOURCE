...
namespace SmartMom_Lib
{
    public partial class frmLabelDesign_P01 : Form
    {
        ...
        {
            DataTable dt = clsStatic.getLabelObject(label_id);
        ...
        private void label_id_dup_check()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                MessageBox.Show("Label ID already exists.");
                return;
            }
        ...
        private void label_object_save(string flag)
        {
            ...
            {
                frmMessage frm = new frmMessage("Label information was not saved.", "OK");
                frm.ShowDialog();
                txtLABEL_SEQ.Text = "";
            }
        }
        ...
        private void label_object_delete()
        {
            ...
            {
                frmMessage frm = new frmMessage("Deletion failed.", "OK");
                frm.ShowDialog();
                txtLABEL_SEQ.Text = "";
            }
        }
        ...
        private void btnLabelListSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please check the duplicate label ID.");
                return;
            }
            label_list_save();
        ...
        private void btnLabelObjectSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter the label information and save it.");
                return;
            }
        ...
        private void grdLabelObject_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter the label list information and save it.");
                return;
            }
        ...
        private void mm_to_fix_main_process(TextBox source, TextBox target, Label title)
        {
            ...
            {
                MessageBox.Show("Please enter a valid '" + title.Text + "' value.");
            }
        }
        ...
        {
            MessageBox.Show("Outputs the GT_LABEL setting value.");
        ...
        private void btnMove_Click(object sender, EventArgs e)
        {
            ...
            {
                frmMessage frm = new frmMessage("Please enter moving coordinates first.", "OK");
                frm.ShowDialog();
                return;
            }
        ...
        private void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            Byte[] bytes = File.ReadAllBytes(txtFile.Text.Trim());
            String file = clsStatic.rest_replace_excel_encoder(Convert.ToBase64String(bytes));

            excel_update(file);
        }

        private void excel_update(String strBase64)
        {
            List<Dictionary<string, object>> paramsList = new List<Dictionary<string, object>>();
            Dictionary<string, object> paramsMap = new Dictionary<string, object>();
            paramsMap.Add("p_err_code", "");
            paramsMap.Add("p_err_msg", "");
            paramsMap.Add("P_CREATE_BY",     clsStatic._USER_ID);
            paramsMap.Add("ID_RULE",         comboIDRule.Text);
            paramsMap.Add("EXCEL_FILE",      strBase64);
            paramsMap.Add("EXCEL_LANDSCAFE", comboExclelLandscape.Text);
            paramsMap.Add("LABEL_ID",        txtLabelID.Text);
            ...
            DataTable dt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.update_labellistExcel.dummy", paramsList, clsStatic._serviceUsertURL, ref retvalue);
        }
        ...
        private void btnFile_Click(object sender, EventArgs e)
        {
            ...
            {
                Title = "Browse SmartMOM Excel Files",
            ...
            {
                txtFile.Text = openExcel.FileName.Trim();
            }
        }
    }
}