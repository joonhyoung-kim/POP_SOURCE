...
namespace SmartMom_Lib
{
    public partial class frmLabelDesign : Form
    {
        ...
        public frmLabelDesign()
        {
            ...
            if(dt1 == null)
            {
                frmMessage frm1 = new frmMessage("Please enter the printer information.", "OK");
                frm1.ShowDialog();
        ...
        {
            //                                   0               1               2                3             4              5            6  
            string[] headerText = new string[] { "LABEL ID",    "LABEL DESC",   "PRINT ID",       "CREATE BY",  "CREATE DATE", "UPDATE BY", "UPDATE DATE" }; //7
        ...
        {
//                                               0               1               2               3  
            string[] headerText = new string[] { "METHODID",     "METHODDESC",  "METHODFIELD",   "METHODFIELDDESC" }; //4
        ...
        private void grdLabelList_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string label_id = grdLabelList.Rows[rownum].Cells["LABEL ID"].Value.ToString();
            string print_id = grdLabelList.Rows[rownum].Cells["PRINT ID"].Value.ToString();
        ...
        private void btnLabelObjectUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select Label List!");
                return;
            }
        ...
        private void btnLabelWizard_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < grdLabelList.Rows.Count; i++)
            {
                ...
                {
                    label_id = grdLabelList.Rows[i].Cells["LABEL ID"].Value.ToString();
                    print_id = grdLabelList.Rows[i].Cells["PRINT ID"].Value.ToString();
                    checkbuf++;
                }
            }
            ...
            {
                MessageBox.Show("Please select only one Label List!");
            }
        }
