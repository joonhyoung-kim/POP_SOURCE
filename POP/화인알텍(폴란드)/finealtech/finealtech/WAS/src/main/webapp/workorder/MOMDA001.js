...
var MOMDA001 = {
	...
	getWorkOrderCreatePop : function() {
	...
	createCallback : function(data, type){
		var that = this;
		var param = that.getWorkOrderCreatePop();
		if(data != null && data != ""){
	...
	createCallbackPost : function(param, data) {
		if(param == 'SUCCESS'){
	...
	delProductOrderCallback : function(param, data, callbackParam){
		var that = this.MOMDA001;
		var arrayList = [];
		if(param == 'SUCCESS'){
	...
	listCallback : function(param, data){
		var that = this.MOMDA001;
		if(param == 'SUCCESS'){
	...
	delProductListCallback : function(param, data){
		var that = this.MOMDA001;
		var parameters = {
			menuId : "MOMDA001"
			, tableId : "MOM_PRODUCT_ORDER"
	...
	delCallbackPost : function(param, data, callbackParam){
		if(param == 'SUCCESS'){
