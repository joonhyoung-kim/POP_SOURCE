...
var MOMJA094 = {
	...
	event: function() {
		...
		$(document).on("click", ".gridEditBtn", function() {
			...
			$("#pCreateBy, #pCreateTime").attr("readonly", "readonly");
	...
	setItemStockControlPop: function(data) {
		...
		$("#pCreateBy").val(data.updateBy || "");
		$("#pCreateTime").val(data.updateDate || "");
		$("#pDescription").val(data.description || "");
		$("#pDeptName, #pCreateBy, #pCreateTime").attr("readonly", "readonly");
	},
