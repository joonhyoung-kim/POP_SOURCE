				...
				micaCommon.messageBox({type:"info", width:"400", height: "145", html:Language.lang['MESSAGES10664'], closeButton:{text:"Close"}, okButton:{text:"OK", 
					after:function(){
						for(var i = 0; i < checkedItems.length; i++){
							...
							mom_ajax("D","reference.itemInfo.item.item", JSON.stringify(param), that.callbackPost, callbackChk);
						}
					}
				}});
			} else {
...
//				callBack();
	...
	getItemPop: function() {
		...
		var result ={
				...
				popLabelDesc : $("#labeldescModal").val(),
				popLabelSpec : $("#labelspecModal").val()
		}
		return result;
	},	
...
//				mCommon.render("grid", "W201806271409484671000DIUlFGxQPU0",  that.getSearchData(), function(){
