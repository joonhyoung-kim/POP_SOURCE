...
var MOMFA004 = {
	...
	comboBox : function() {
		...
		// 고객사, 도착지
		mCommon.comboBoxClickCall("#customerName, #destinationName", function(callBack) {
	...
	printCallback : function(param, data) {
	...
	printDelCallback : function(param, data) {
		var that = this.MOMFA004;
		if(param == 'SUCCESS') {
			params = {
				menuId : menuId
	...
	printCallbackProc : function(param, data) {
		var that = this.MOMFA004;
		if(param = 'SUCCESS') {
			var checkedItems = AUIGrid.getCheckedRowItems("grid");
