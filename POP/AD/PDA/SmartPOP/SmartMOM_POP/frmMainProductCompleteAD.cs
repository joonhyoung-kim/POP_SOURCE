...
namespace SmartMOM_POP
{
    public partial class frmMainProductCompleteAD : Form
    {
        ...
        private void btnWorker_Click(object sender, EventArgs e)
        {
            ...
            frmLoginIDInsert2 frm = new frmLoginIDInsert2(clsStatic._PERSONCOUNT);
            frm.ShowDialog();
        ...
        private void btnPallet_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    //Pallet라벨 발생
                    create_pallet_label(retbuf); //팔레트 발행

                    //라벨Print
                    ganban_print(retbuf);

                    delete_ganbanTmp(retbuf);//프린트 대기열 삭제
        ...
        /// 프린터초기화
        /// </summary>
        private void buttonPrintCls_Click(object sender, EventArgs e)
        {
          
            delete_printTmp();

            
                frmMessage2 frm = new frmMessage2("프린터대기열 초기화 완료되었습니다.", "AUTOCLOSE");
                frm.ShowDialog();
        ...
        private void delete_ganbanTmp(String labelid)
        {
            string retvalue = "";
        ...
        private void delete_printTmp()
        {
            ...
            paramsMap.Add("P_COMPANY_CD", clsStatic._COMPANY_CD);
            paramsList.Add(paramsMap);
            DataTable dt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.deleteGanbanTmpAll.dummy", paramsList, clsStatic._serviceUsertURL, ref retvalue);
        }
        //작업지시 정보 조회   
        ...
        private void lblMakelotqty_Click(object sender, EventArgs e)
        {
            ...
            frmLoginIDInsert2 frm = new frmLoginIDInsert2(lblMakelotqty.Text);
            frm.ShowDialog();
        ...
        private void button_label_print()
        {
            ...
            if (planQty <= double.Parse(prodQty))
            {
                ...
                frmLoginIDInsert2 frm = new frmLoginIDInsert2(inputQty);
                frm.ShowDialog();
...
/*
        ...
        private void lblProductorderid_Click(object sender, EventArgs e)
        {

        }

        private void lblBoxCount_Click(object sender, EventArgs e)
        {
