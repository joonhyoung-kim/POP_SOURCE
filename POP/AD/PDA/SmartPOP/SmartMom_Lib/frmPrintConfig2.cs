...
{
    public partial class frmPrintConfig2 : Form
    {
        string _insert_flag = "I";
        string _maccAddress = "";
        public frmPrintConfig2()
        {
            InitializeComponent();
        ...
        private void btnGT_Click(object sender, EventArgs e)
        {
            ...
            {
                frmMessage2 frm1 = new frmMessage2("출력 PORT 값이 NONE이면 인쇄가 되지 않습니다.", "AUTOCLOSE");
                frm1.ShowDialog();
                return;
            }
        ...
        {
            frmMessage2 frm = new frmMessage2("저장하시겠습니까?", "OK_CANCEL");
            ...
            if (result == DialogResult.OK)
            {
                ...
                {
                    frmMessage2 frm1 = new frmMessage2("모든 값을 입력하여 주세요.", "OK");
                    frm1.ShowDialog();
                    return;
                }
                ...
                if (macDt.Rows.Count > 0)
                {
                    ...
                    {
                        frmMessage2 frm1 = new frmMessage2("프린터 정보가 저장되었습니다.", "OK");
                        frm1.ShowDialog();
                    }
                    else
                    {
                        frmMessage2 frm1 = new frmMessage2("프린터 정보가 저장되지 않았습니다!!!", "OK");
                        frm1.ShowDialog();
                    }
                }
            }
