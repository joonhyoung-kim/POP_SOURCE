...
namespace SmartMOM_POP
{
    public partial class frmGanbanManual : Form
    {
        ...
        public frmGanbanManual(string stocknm, string stock_id, string item_id, string qty)
        {
            ...
            lblQty.Text = double.Parse(qty).ToString("##,##0.##");
            item_search();
        ...
        private void InitGanbanList()
        {
            ...
            string[] headerText = new string[] { "사용여부",     "현재창고",      "간판라벨번호",  "품목",     "구성수량",   "발주번호",         "W/O",         "이동일자",      "이동담당자",    "생성자",    "생성일자"    }; //13
            string[] columnName = new string[] { "USEYN",        "LOCATIONCD",    "GANBANID",      "ITEMID",   "QTY",        "DEPARTUREGROUPID", "WORKORDERID", "MOVEDATE",      "MOVEBY",        "NAME",      "CREATEDATE"  };
            string[] columnType = new string[] { "T",            "T",             "T",             "T",        "T",          "T",                "T",           "T",             "T",             "T",         "T"          };
                                                                                                                                                                                                                           
            int[] columnWidth    = new int[]   {  130,            160,             200,            270,        150,          300,                200,           250,             200,             200,         250          };
            ...
            string[] cellAlign = new string[]  { "C",             "C",            "C",             "L",        "C",          "C",                "C",           "C",             "C",             "C",         "C"          };
        ...
        private void search_process()
        {
            ...
            paramsMap1.Add("ITEM_ID", txtItem.Text);
            paramsMap1.Add("LOCATION_CD", _stock_id);
        ...
        {
            if(lblQty.Text.Trim() == "" || lblQty.Text.Trim().Replace(",","") == "0")
            {
            ...
            if (double.Parse(lblQty.Text.Trim().Replace(",", "")) == 0)
            {
            ...
            paramsMap.Add("P_GOOD_QTY",           lblQty.Text.Replace(",", ""));
            paramsMap.Add("P_FROM_SLOC",          _stock_id);
            paramsMap.Add("P_DESCRIPTION",        "Ganban Manual Creation");
            ...
            frmMessage frm4 = new frmMessage("간판라벨이 정상적으로 발행되었습니다.(" + ganbanAddDt.Rows[0]["p_ganbanid"].ToString() + ")", "AUTOCLOSE");
            frm4.ShowDialog();
        ...
        private void label3_Click(object sender, EventArgs e)
        {
            ...
            frmLoginIDInsert frm = new frmLoginIDInsert(lblQty.Text.Replace(",",""));
            frm.ShowDialog();
        ...
        private void lblQty_Click(object sender, EventArgs e)
        {
            ...
            frmLoginIDInsert frm = new frmLoginIDInsert(lblQty.Text);
            frm.ShowDialog();
