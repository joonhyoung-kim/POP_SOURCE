...
namespace SmartMom_Lib
{
    static public class clsStatic
    {
        ...
        public static string _CHKUSEMANAGEMENT="1";
        ...
        public static string _DIVISION_CD = "EDUKR";
        public static string _COMPANY_CD = "EDUDEMO";
        /* public static string _DIVISION_CD = "EBESCO";
         public static string _COMPANY_CD = "EBESCO";*/
     /*   public static string _DIVISION_CD = "AD";
        public static string _COMPANY_CD = "ADINT";*/
        public static DataTable _BADCODE_LIST = new DataTable();
        ...
        public static DataTable getLabelObject(string label_id, string print_id)
        {
            List<Dictionary<string, object>> paramsList = new List<Dictionary<string, object>>();
            Dictionary<string, object> paramsMap = new Dictionary<string, object>();
            paramsMap.Add("p_err_code", "");
        ...
        public static DataTable getDivisionList()
        {
            ...
            DataTable dt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.get_division_list.dummy", paramsList, clsStatic._serviceSelectURL, ref retvalue);

            return dt;
        }

        public static DataTable getBadCodeList()
        {
            List<Dictionary<string, object>> paramsList = new List<Dictionary<string, object>>();
            Dictionary<string, object> paramsMap = new Dictionary<string, object>();
            paramsMap.Add("p_err_code", "");
            ...
            DataTable dt = clsUtil.GetServiceData("com.thirautech.mom.pop.popResult.get_badCode_list.dummy", paramsList, clsStatic._serviceSelectURL, ref retvalue);
