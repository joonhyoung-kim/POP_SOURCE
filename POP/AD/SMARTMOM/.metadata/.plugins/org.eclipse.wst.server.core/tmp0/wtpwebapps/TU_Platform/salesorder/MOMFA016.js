...
$.ajax({
	...
	type : "GET",
	data : {codeClassId : "FACILITY_TYPE", attribute25 : "Y"},
	async: false,
	timeout 	: 30000000,
	dataType 	: 'json',
...
var MOMFA016 = {
	init: function() {
		...
		$(document).on("click","#findBtn",function(){
			mCommon.render("grid", "W201808261506238871001QYMnspycuXT", that.getSearchParam(), function(){});
		});
