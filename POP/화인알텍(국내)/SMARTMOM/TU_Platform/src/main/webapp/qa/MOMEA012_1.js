		...
		if(indexInfo != undefined && indexInfo['op'] == 'returnBtn2' && indexInfo['sequence'] == 1) {
			for(var i = 0; i < callBackParam.length; i++) {
				if(callBackParam[i]['returnQty'] <= 0 || callBackParam[i]['returnQty'] == '') {
					this.initParam = Language.lang['MESSAGES10435'];
					return;
				} else if(callBackParam[i]['returnType'] == '') {
					this.initParam = Language.lang['MESSAGES10437'];
					return;
				} else if(callBackParam[i]['returnLocation'] == '') {
					this.initParam = Language.lang['MESSAGES10444'];
					return;
				} else if(callBackParam[i]['returnDate'] == '') {
					this.initParam = Language.lang['MESSAGES10440'];
					return;
				} else if(callBackParam[i]['marketCd'] == '') {
					this.initParam = Language.lang['MESSAGES10044'];
					return;
