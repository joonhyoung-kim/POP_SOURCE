...
namespace SmartMom_Lib
{
    public static class clsLabelSet
    {
        ...
        public static void label_print(string _macAddress, string printid, string pallet, string gt, string ct, string ganbanid, string reprintFlag, ref DataSet BasicDs, String divisionCd, String companyCd, String workorderId)
        {  
            List<Dictionary<string, object>> paramsList = new List<Dictionary<string, object>>();
            Dictionary<string, object> paramsMap = new Dictionary<string, object>();
            string retvalue = "";
            ...
            else if(ct != "")
            {
                ...
                paramsMap.Add("DIVISION_CD", divisionCd);
                paramsMap.Add("COMPANY_CD", companyCd);
                paramsMap.Add("WORK_ORDER_ID", workorderId);
                paramsMap.Add("CT", ct);
