...
namespace SmartMOM_POP
{
    public partial class frmGanban : Form
    {
        ...
        private void insertGanban()
        {
            ...
            {
                frmMessage frm1 = new frmMessage("이미 라벨이 발행되었거나, 간판라벨 설정이 되지 않았습니다.", "AUTOCLOSE");
                frm1.ShowDialog();
                txtSN_Focus();
                return;
            }
        ...
        private void btnAutoLabelPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                frmMessage frm1 = new frmMessage("간판 생성 가능 수량이 0입니다.(생성불가)", "AUTOCLOSE");
                frm1.ShowDialog();
                return;
            }
            ...
            {
                frmMessage frm1 = new frmMessage("박스 구성 수량이 0입니다.", "AUTOCLOSE");
                frm1.ShowDialog();
                return;
            }
