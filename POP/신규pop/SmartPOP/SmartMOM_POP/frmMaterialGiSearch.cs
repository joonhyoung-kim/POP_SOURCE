...
{
    public partial class frmMaterialGiSearch : Form
    {
        ...
        private void InitGridList()
        {
            ...
            string[] headerText = new string[] { "투입예정품목", "투입예정품명", "지시수량", "현재고량", "작업예정위치", "현재고", "계획수량", "요청수량", "잔량", "스캔수량", "요청일", "구분", "요청창고ID", "요청창고", "요청유형", "불출요청번호", "Market", "OUTSOURCINGFLAG", "단위", "단위수량", "환종", "LABELYN" };
            ...
            int[] columnWidth = new int[] { 450, 450, 300, 300, 450, 130, 130, 130, 130, 130, 160, 80, 270, 270, 140, 250, 250, 250, 250, 250, 250, 100 };
            bool[] columnVisible = new bool[] { true, true, true, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false };
            ...
            string[] cellAlign = new string[] { "L", "L", "R", "R", "L", "R", "R", "R", "R", "R", "C", "C", "L", "L", "R", "C", "C", "C", "C", "C", "C", "C" };
...
/*        private void btnPageInit_Click(object sender, EventArgs e)
       ...
       /* private void btnGanbanManual_Click(object sender, EventArgs e)
        ...
        private void frmMaterialGI_Load(object sender, EventArgs e)
        {
        ...
        private void lblFromStock_Click(object sender, EventArgs e)
        {
