...
namespace SmartMOM_POP
{
    public partial class frmPOSearch : Form
    {
        ...
        public frmPOSearch(string wo_state, string product_order_type)
        {
            InitializeComponent();

            _wo_state = wo_state;
            _product_order_type = product_order_type;
        ...
        private void InitLabelList()
        {
            ...
            string[] headerText = new string[] { "작업지시번호", "품목",    "품명",     "지시량",     "양품수량",  "잔량수량", "고객사제번",     "규격",          "작업일자",   "불량수량",    "작업지시유형", "상태",         "입력기본수량",  "입력방식",     "CT구성수량",   "GT라벨ID",      "CT라벨ID",      "PALLET라벨ID"      }; //18
            string[] columnName = new string[] { "WORKORDERID",  "ITEMID",  "ITEMNAME", "CONFIRMQTY", "QTY",       "REMAINQTY","PRODUCTORDERID", "SPECIFICATION", "PLANDATE",   "BADQTY",      "WOTYPENAME",   "WOSTATENAME",  "POPMAKELOTQTY", "POPINPUTTYPE", "POPCTQTY",     "POPGTLABELID",  "POPCTLABELID",  "POPPALLETLABELID"  };
            string[] columnType = new string[] { "T",            "T",       "T",        "T",          "T",         "T",        "T",              "T",             "T",          "T",           "T",            "T",            "T",             "T",            "T",            "T",             "T",             "T"                 };
                                                                                                                                                                  
            int[] columnWidth    = new int[]   { 290,            248,       300,        120,          120,         120,        248,              200,             210,          80,            100,            230,            100,             100,            100,            100,             100,             100                 };
            ...
            string[] cellAlign = new string[]  { "C",            "L",       "L",        "R",          "R",         "R",        "C",              "L",             "C",          "R",           "C",            "C",            "C",             "C",            "C",            "C",             "C",             "C"                 };
        ...
        private void wo_search()
        {
            ...
            paramsMap.Add("PRODUCT_ORDER_TYPE", _product_order_type);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if (_wo != "")
            {
                ...
                /*
                if (popinputtype == "BUTTON" && popctlabelid.Trim() == "")
                {
                    frmMessage frm1 = new frmMessage("선택한 파트넘버의 기준정보를 확인하여 주세요!(관리자에게 문의 하세요)", "AUTOCLOSE");
                    frm1.ShowDialog();
                    return;
