...
var MOMAA000 = {
	...
	getWoresultId : function() {
		...
		$.ajax({
			url : tuCommon.contextPath()
					+ "/mom/request/com.thirautech.mom.pop.popResult.woResult.dummy",
			type : "GET",
			data : param,
			async : false,
			timeout : 30000000,
	...
	performDelete : function(lotId) {
		...
		mom_ajax("C", "pop.popResult.workOrderResultCancel", JSON.stringify(param), that.performDeleteCallback);
