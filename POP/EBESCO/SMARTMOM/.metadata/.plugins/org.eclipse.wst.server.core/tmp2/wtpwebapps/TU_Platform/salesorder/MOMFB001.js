	...
	init: function() {
		Language.init(function() {
			momWidget.isInitGrid(0, function() {
				date2String19(momWidget.grid[0], ['productionDate','productionStartDate','productionEndDate']);
				mom_ajax('R', 'common.b2biDeployTime?b2biType=PLAN', {}, function(result, data) {
...
$(document).ready(function(event) {
	momWidget.init(1, 'MOMFB001', MOMFB001);
	MOMFB001.init();
});