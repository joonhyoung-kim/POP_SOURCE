...
var MOMJA002 = {
	init: function() {
		...
		$("#SaveBtn").click(function(event){
			var updateDate = get_current_date('YYYY-MM-DD HH24:MI:SS');
	...
	comboBox: function() {
		...
		$.get(tuCommon.contextPath() + "/mom/request/com.thirautech.mom.common.comCode.dummy", // 호출 URL
			...
			function(data) {
				...
				micaCommon.comboBox.set("#mergeuseflag",{searchMode:'containsignorecase', autoComplete:true, selectedIndex:1}, options);
	...
	setSetup : function (){
		...
		$.ajax({
			...
			success : function(data){
				...
				$("#mergeuseflag").val(dataSetup.mergeUseFlag);
