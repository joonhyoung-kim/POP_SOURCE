var MOMCD001_1= {
	...
	init: function() {  
		...
		/*start code_id : SC2020041946 2020.05.15 박연주 명세표출력 이벤트 추가*/
    	$(document).on('click', '#specPrintBtn1', function() {
			...
			momWidget.specPrint('MOMCD001'
				, undefined
				, 'purchase.material.materialRequest.materialRequestExcelPrint'
				, 'workOrderId'
				, 'toDate' + '=' + $("#toDate").val() + '&fromDate'
				, $("#fromDate").val()
				, param
				, Language.lang['MESSAGES12183']
			);
		});
    	/*end code_id : SC2020041946 2020.05.15 박연주 명세표출력 이벤트 추가*/
	}, design: function(){
